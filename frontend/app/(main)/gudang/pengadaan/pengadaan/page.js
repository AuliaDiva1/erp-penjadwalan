...
import FormTambahPengadaan from '../pengadaan/components/FormTambahPengadaan';
import FormKonfirmasi from '../pengadaan/components/FormKonfirmasi';
  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        >
          ...
          <Column
            ...
            body={(row) => (
              row.is_auto
                ? <Tag value="Sistem" severity="info" />
                : <span className="text-sm">{row.created_by_name || '-'}</span>
            )}
          />
          <Column
            header="Catatan"
            ...
            body={(row) => {
              ...
              return (
                <Button
                  ...
                  tooltip={row.status === 'pending' ? 'Proses Pengadaan' : 'Selesaikan Pengadaan'}
      ...
      <FormTambahPengadaan
        ...
        onHide={() => setTambahVisible(false)}
        onSave={() => {
          toast.current.show({ severity: 'success', summary: 'Berhasil', detail: 'Pengadaan manual berhasil dibuat' });
          fetchRiwayat();
        }}
      />
